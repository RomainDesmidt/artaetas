...
var data = /** @class */ (function () {
    ...
    data.prototype.search = function (search) {
        ...
        var searchFilter = this.main.searchFilter;
        ...
        var filtered = valuesArray.map(function (obj) {
            ...
            if (obj.hasOwnProperty('options')) {
                ...
                var options = optgroupObj.options.filter(function (opt) {
                    return (typeof searchFilter !== 'function')
                        ? opt.text.toLowerCase().indexOf(search) !== -1
                        : searchFilter.call(this, optionObj.text.toLowerCase(), search);
                });
                if (options.length !== 0) {
            ...
            if (obj.hasOwnProperty('text')) {
                ...
                if(typeof searchFilter === 'function') {
                    if(searchFilter.call(this, optionObj.text.toLowerCase(), search)) {
                        return obj;
                    }
                }
                else if (optionObj.text.toLowerCase().indexOf(search) !== -1) {
                    return obj;
                }
            }
            return null;
...
var SlimSelect = /** @class */ (function () {
    function SlimSelect(info) {
        ...
        // Add searchFilter if option is passed in
